...
## My Contributions (Individual Contribution > 90%)
**Project Background**: Performance optimization based on the baseline model provided in the course (59% accuracy)

**My Core Optimization Work**:

- **Model Architecture Restructuring**: Upgraded a simple CNN to a 13-layer residual network to enhance feature extraction capabilities.

- **Training Strategy Innovation**: Introduced Mixed Precision Training (AMP), improving training speed by 30% and reducing GPU memory usage.

- **Loss Function Optimization**: Designed a multi-task learning framework (BCE + auxiliary cross-entropy loss).

- **Data Augmentation Improvements**: Implemented a label swapping strategy to effectively improve the model's generalization ability.

**Optimization Results**:

- Test accuracy improved from 59% to 75.9% (a relative improvement of 28%)

- Model parameter size controlled at 504K, maintaining lightweight characteristics

- Training time reduced to 7 minutes and 40 seconds, supporting efficient training in CPU environments

**Team Division of Labor**: I was responsible for all technical optimization work; other team members participated in brainstorming and PPT creation.
...
### Data Access
**Due to academic integrity and copyright considerations, the original dataset is not included in this repository.**

**For technical reviewers requiring a complete reproduction:**

**Please contact me via ozakikinji55@gmail.com to obtain the data package and detailed operating instructions.**


**Please drag the data folder to the directory ./src**
